# CerberusFX Tools — 50er-Liste & Status

Live-Repo: `cerberusfx.github.io/tools/`
Kanal: `t.me/CerberusFXTrading`
...
15. ⬜ Monte Carlo Equity Simulator — 500 Verläufe deiner Strategie, Bandbreite statt Einzelpfad
16. ✅ **Risk of Ruin Calculator** — Wahrscheinlichkeit, das Konto zu verlieren
17. ⬜ Session Overlap Timer — Handelszeiten in deiner Zeitzone, London/NY-Overlap
18. ⬜ Trade Cost Calculator — Spread, Kommission und Slippage als echter %-Anteil am Gewinn
...
32. ⬜ Net Worth Tracker — Vermögen minus Schulden, mit Zielverlauf

*(Zusätzlich bereits umgesetzt, nicht 1:1 in dieser Liste: Compound Interest Calculator, Retirement Withdrawal Simulator)*
...
50. ⬜ Decision Matrix Tool — gewichtete Bewertung mehrerer Optionen nebeneinander
...
1. Tool bauen (Kategorien mischen, nie Rückfrage — Claude wählt selbst)
2. Ins GitHub-Repo `CerberusFX/tools` pushen → Live-Link über GitHub Pages
